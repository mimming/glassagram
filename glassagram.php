...
switch ($_POST['operation']) {
    ...
    case "deleteAll":
        deleteAllTimelineItems($mirror_service);
...
<div class="container">
    ...
    <div class="row">
        <div class="span4">
            ...
            <p>When you first sign in, Glassagram inserts a welcome message. Use
            ...
            <form method="post">
                ...
                <button class="btn" type="submit">Delete All Cards Inserted by Glassagram</button>
            </form>
            ...
            <form method="post">
                <input type="hidden" name="operation" value="insertItem">
                <textarea name="message">iSeeDeadPixels: scroll through the screens to view </textarea><br/>
                <button class="btn" type="submit">The above message</button>
            </form>
            ...
            <form method="post">
                ...
                <input type="hidden" name="message"
                       value="Square">
                <input type="hidden" name="imageUrl" value="<?= $base_url .
                    "/debug/IMG_20130420_125910-chantal-guillon.jpg" ?>">
                <input type="hidden" name="contentType" value="image/jpeg">
