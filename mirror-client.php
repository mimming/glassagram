...
// Modified by: Winnie Tong for Glassagram
...
function insertContact($service, $contactId, $displayName, $iconUrl, $acceptTypes=null)
{
  try {
    ...
    if ($acceptTypes) {
        $contact->setAcceptTypes($acceptTypes);
    }
 ...
 * @return string The attachment's content if successful, null otherwise.
 */
function downloadUrl($itemId, $url) {
